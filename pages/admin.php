                          ...
                          echo '<li class="nav-item">
                                  ...
                                  <div class="collapse" id="monhoc">
                                    <ul class="nav flex-column sub-menu">
                                      <li class="nav-item">
                                        <a class="nav-link" href="xemthongtinmonhoc.php?iduser='.$row['iduser'].'&level='.$row['level'].'&hinhanhuser='.$row['hinhanhuser'].'&username='.$username.'"> Xem thông tin môn học </a>
                                      </li>
                                      <li class="nav-item">
                                        <a class="nav-link" href="themmonhoc.php?iduser='.$row['iduser'].'&level='.$row['level'].'&hinhanhuser='.$row['hinhanhuser'].'&username='.$username.'"> Thêm môn học</a>
                                      </li>
                                    </ul>
                                  </div>
                                </li>';
