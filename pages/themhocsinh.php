  ...
  <body>
   ...
   <table class="table table-light " style="border:1px solid black">
       ...
       <tr>
           ...
           <tr>
                                <form action="themhocsinh1.php" method="post">
                                        <!-- <td></td> -->
                                        ...
                                        <td><input  type="text" name="idhocsinh" value="<?php ?>"></td>
                                        <td><input  type="text" name="emailhocsinh" value="<?php ?>"></td>
                                       

                                        
                                        <td><input  type="submit" value="Thêm học sinh "></td>
                                </form>        
