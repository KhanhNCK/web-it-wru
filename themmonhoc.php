...
<html lang="en">
  ...
  <?php require 'headerphp.php'?>
   ...
   <h1>Thêm môn học của user:  <?php echo $username;?></h1>
   ...
   <table class="table table-light " style="border:1px solid black">
       ...
       <tr>
           ...
           <tr>
                                <form action="themmonhoc1.php" method="post">
                                        <!-- <td></td> -->
                                        ...
                                        <td><input  type="text" name="tenmonhocthem" value=""></td>
                                        <td><input  type="text" name="ngaybatdauthem" value=""></td>
                                        <td><input  type="text" name="ngayketthucthem" value=""></td>
                                        <td><input  type="text" name="trangthaithem" value=""></td>

                                        
                                        <td><input  type="submit" value="Thêm môn học"></td>
                                </form>        
